    ...
    <section className="py-12 xl:py-0 xl:h-[90vh]  mb-4 overflow-none bg-slate-50">
      <div className="container mx-auto xl:w-full xl:h-full flex xl:justify-center xl:items-center">
        <div className="w-full flex flex-col lg:flex-row gap-12 xl:gap-20">
          {/* Left Column */}
          <div className="pt-6 md:pt-0 flex-1 flex flex-col justify-around items-end text-center xl:text-left gap-12 xl:gap-0 mx-auto xl:max-w-none xl:mx-0 bg-white">
          ...
          {/* Right Column */}
          <div className="pt-6 md:pt-0 border-t-5 border-t-orange-400 flex-1 flex flex-col justify-around text-center xl:text-left gap-12 xl:gap-0 mx-auto xl:max-w-none xl:mx-0 bg-white">
